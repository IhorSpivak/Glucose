...
import com.sa90.materialarcmenu.MenuSideEnum;
import com.sa90.materialarcmenu.MoveUpwardBehaviour;
...
public class ArcMenu extends FrameLayout {
    ...
    private float mCurrentRadius, mFinalRadius, mElevation;
    private int menuMargin;
    private boolean mIsOpened = false;
    private double mQuadrantAngle;
    private MenuSideEnum mMenuSideEnum;
    private int cx, cy; //Represents the center points of the ex_bg whose arc we are considering
...
//            fabMenu.setElevation(mElevation);
    ...
    private OnClickListener mMenuClickListener = v -> toggleMenu();
